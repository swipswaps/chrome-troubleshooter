...
from chrome_troubleshooter.constants import CHROME_BINARIES, LOCK_FILE, SESSION_FMT
from chrome_troubleshooter.utils import (
    format_duration,
    format_size,
    json_dumps,
    json_loads,
...
class TestEnhancedCLI:
    ...
    def test_utils_import(self):
        ...
        from chrome_troubleshooter.utils import check_system_dependencies, which_chrome
